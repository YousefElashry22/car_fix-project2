...
export default function Hero({ onBookService = () => window.location.assign('/contact') }: HeroProps) {
  return (
    <section className="site-hero relative h-[100svh] min-h-[100svh] w-full overflow-hidden bg-[#0B0D0F]">
      <motion.video
